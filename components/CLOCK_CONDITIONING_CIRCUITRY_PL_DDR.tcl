# Family: PolarFireSoC
# Create and Configure the core component CLOCK_CONDITIONING_CIRCUITRY_PL_DDR
create_and_configure_core -core_vlnv {Actel:SgCore:PF_CCC:*} -component_name {CLOCK_CONDITIONING_CIRCUITRY_PL_DDR} -params {\
