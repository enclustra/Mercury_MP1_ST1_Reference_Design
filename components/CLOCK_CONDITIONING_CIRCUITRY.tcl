# Create and Configure the core component CLOCK_CONDITIONING_CIRCUITRY
create_and_configure_core -core_vlnv {Actel:SgCore:PF_CCC:*} -component_name {CLOCK_CONDITIONING_CIRCUITRY} -params {\
