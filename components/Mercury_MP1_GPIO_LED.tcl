# Family: PolarFireSoC
# Create and Configure the core component Mercury_MP1_GPIO_LED
create_and_configure_core -core_vlnv {Actel:DirectCore:CoreGPIO:*} -component_name {Mercury_MP1_GPIO_LED} -params {\
"APB_WIDTH:32"  \
"FIXED_CONFIG_0:true"  \
"FIXED_CONFIG_1:true"  \
"FIXED_CONFIG_2:true"  \
