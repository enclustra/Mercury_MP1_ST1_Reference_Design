# Family: PolarFireSoC
# Create and Configure the core component Mercury_MP1_GPIO_UART_SEL
create_and_configure_core -core_vlnv {Actel:DirectCore:CoreGPIO:*} -component_name {Mercury_MP1_GPIO_UART_SEL} -params {\
"APB_WIDTH:32"  \
